...
// We use the car suffix here to avoid naming collision between a player and the ball in Three
...
export class AnimationBuilder {
  ...
  public playAnimationClips() {
    ...
    const ballAction = this.animator.ballMixer.clipAction(
      this.animator.ballClip
    )
